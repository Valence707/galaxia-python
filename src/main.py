...
textures = {
    'dirt': pygame.image.load('./res/images/dirt.png').convert(),
    'grass_dirt': pygame.image.load('./res/images/grass_dirt.png').convert(),
    'stone': pygame.image.load('./res/images/stone.png').convert(),
    'cloud_1': pygame.image.load('./res/images/cloud_1.png').convert(),
    'cloud_2': pygame.image.load('./res/images/cloud_2.png').convert(),
    'cloud_3': pygame.image.load('./res/images/cloud_3.png').convert(),
    'cloud_4': pygame.image.load('./res/images/cloud_4.png').convert(),
    'mountains': pygame.image.load('./res/images/mountains.png').convert(),
    'hotbar': pygame.image.load('./res/images/hotbar.png').convert(),
    'hotbar_selected': pygame.image.load('./res/images/hotbar_selected.png').convert(),
    'stone_pickaxe': pygame.image.load('./res/images/stone_pickaxe.png').convert(),
    'stone_shovel': pygame.image.load('./res/images/stone_shovel.png').convert(),
    'stone_axe': pygame.image.load('./res/images/stone_axe.png').convert(),
    'stone_club': pygame.image.load('./res/images/stone_club.png').convert(),
    'dirt_wall': pygame.image.load('./res/images/dirt_wall.png').convert(),
    'stone_wall': pygame.image.load('./res/images/stone_wall.png').convert(),
    'grass_0': pygame.image.load('./res/images/grass_0.png').convert(),
    'grass_1': pygame.image.load('./res/images/grass_1.png').convert(),
    'grass_2': pygame.image.load('./res/images/grass_2.png').convert(),
    'grass_3': pygame.image.load('./res/images/grass_3.png').convert(),
    'grass_4': pygame.image.load('./res/images/grass_4.png').convert(),
    'grass_5': pygame.image.load('./res/images/grass_5.png').convert(),
    'tree_top': pygame.image.load('./res/images/tree_top.png').convert(),
    'tree_middle': pygame.image.load('./res/images/tree_middle.png').convert(),
    'tree_bottom': pygame.image.load('./res/images/tree_bottom.png').convert(),
    'coal_ore': pygame.image.load('./res/images/coal_ore.png').convert(),
    'copper_ore': pygame.image.load('./res/images/copper_ore.png').convert(),
    'iron_ore': pygame.image.load('./res/images/iron_ore.png').convert(),
    'gold_ore': pygame.image.load('./res/images/gold_ore.png').convert()
}
